...
# no longer used - workaround for cost_export_exists and initial IAM S3 policy permission issue
...
# used only for testing the S3 IAM role for assumed azure role
