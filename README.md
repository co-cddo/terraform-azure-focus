...
| Billing account - **EA** | **EnrollmentReader** | Create the daily FOCUS export. The function identity's billing role must be assigned manually - see [the important note below](#ea-billing-role-script). |
