...
| <a name="input_enable_advisor_exports"></a> [enable\_advisor\_exports](#input\_enable\_advisor\_exports) | Whether to enable the Azure Advisor cost recommendations export. Set to false to disable the AdvisorRecommendationsExporter function and its RBAC role assignment. | `bool` | `true` | no |
